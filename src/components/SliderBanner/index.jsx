            ...
            <div className="pt-[32px]">
                ...
                >
                    <div className="group-hover/banners:block hidden absolute top-[50%] left-[25px] translate-y-[-50%] z-10">
                        <Button onClick={prevBanner} className="w-[55px] h-[55px] !bg-purple-bg-btn hover:opacity-80" rounded>
                    ...
                    {bannerArrays.map((items, index) => (
                        <div
                            style={{
                                transition:
                                    'transform 0.55s ease-in-out, opacity 0.45s ease-in-out 0.15s, z-index 0s linear 0.25s',
