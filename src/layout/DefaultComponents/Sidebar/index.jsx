...
function Sidebar() {
    ...
    return (
        <aside
            className={`fixed top-0 left-0 min-h-height-layout max-h-full w-[240px] bg-purple-bg-side-bar transition-all ${
                isExtend ? 'LM:bg-purple-bg-sidebar-mini' : 'LM:w-[70px] LM:bg-purple-bg-sidebar-mini'
            } z-[99]`}
        >
            ...
            >
                <div
                    className={`flex LM:justify-center items-center h-full gap-[20px] text-purple-text-secondary font-medium text-[14px]`}
                >
                    <div
